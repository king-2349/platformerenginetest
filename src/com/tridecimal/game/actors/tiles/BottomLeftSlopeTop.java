...
public class BottomLeftSlopeTop extends Tile{

	public BottomLeftSlopeTop(TileMap map) {
		super(map);
	}
	...
	public void create() {
		...
		TextureRegion[] idleTextures = {new TextureRegion(Constants.sprites,0,96,16,16)};
		super.addAnimation(new Animation<TextureRegion>(1000f,idleTextures));
		
		super.setCollisionHandler(new SlopeCollider(this, new Rectangle(0,0,16,16), Collider.STATIC,-.5f,16f));
	}
