...
public class LeftRightOpenWall extends Tile{
	
	public LeftRightOpenWall(TileMap map) {
		super(map);
	}
	...
	public void create() {
		...
		super.setCollisionHandler(new SlopeAdjacentCollider(this, new Rectangle(0,0,16,16), Collider.STATIC,0));
	}
