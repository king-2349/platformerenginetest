...
public class BottomRightSlopeTop extends Tile{

	public BottomRightSlopeTop(TileMap map) {
		super(map);
	}
	...
	public void create() {
		...
		TextureRegion[] idleTextures = {new TextureRegion(Constants.sprites,16,80,16,16)};
