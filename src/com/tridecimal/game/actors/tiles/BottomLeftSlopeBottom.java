...
public class BottomLeftSlopeBottom extends Tile{

	public BottomLeftSlopeBottom(TileMap map) {
		super(map);
	}
	...
	public void create() {
		...
		TextureRegion[] idleTextures = {new TextureRegion(Constants.sprites,16,96,16,16)};
		super.addAnimation(new Animation<TextureRegion>(1000f,idleTextures));
		
		super.setCollisionHandler(new SlopeCollider(this, new Rectangle(0,0,16,16), Collider.STATIC,-.5f,8f));
	}
